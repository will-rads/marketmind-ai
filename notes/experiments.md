...
**Dataset:**
- 10 categories × 5K reviews = 49,994 reviews (6 dropped for empty text)
- Sampling: top-reviewed products per category (not random) — ensures dense review coverage
- Saved to `data/raw/reviews_50k.parquet` on Google Drive (13 MB)
...
- Product coverage: 4,173 unique products, mean 12 reviews/product, median 7
...
**Next:** Build TF-IDF + Logistic Regression baseline (Notebook 02). Use `class_weight='balanced'`.
